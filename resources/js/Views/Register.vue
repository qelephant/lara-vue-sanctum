                ...
                <div class="p-4 bg-white">
                    ...
                    <form @submit.prevent="register" class="md:w-10/12 md:p-4 w-full mx-auto">
                        ...
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center sm:justify-between">
                            ...
                            <input type="text" name="name" v-model="name" class="border border-gray-300 bg-white sm:w-8/12 w-full p-2 mt-3 sm:mt-0 focus:outline-none rounded-sm" placeholder="Name">
                        </div>
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center sm:justify-between">
                            <label for="Email" class="w-4/12 "> Email </label>
                            <input type="email" name="email" v-model="email" class="border border-gray-300 bg-white sm:w-8/12 w-full p-2 mt-3 sm:mt-0 focus:outline-none rounded-sm" placeholder="test@mail.com">
                        </div>
                        <div class=" w-full my-1 py-2 sm:flex  sm:items-center sm:justify-between">
